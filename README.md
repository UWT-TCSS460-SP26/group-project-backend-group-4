...
4. The only orgins that are CORS-allowed are: `https://group-project-frontend-group-4.onrender.com` and `https://bug-tracker-group4.onrender.com`,
 should you need to get your origin added, please file a bug report and include "CORS Request" in the title.
